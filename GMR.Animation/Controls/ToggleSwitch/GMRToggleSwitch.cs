...
namespace GMR.Animation.Controls.ToggleSwitch
{
    ...
    public class GMRToggleSwitch : Control
    {
        ...
        private ToggleSwitchStyle _style = ToggleSwitchStyle.Carbon;
        ...
        public bool AllowUserChange { get => _allowUserChange; set => _allowUserChange = value; }


        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public string CheckedString { get => Checked ? (string.IsNullOrEmpty(OnText) ? "ON" : OnText) : (string.IsNullOrEmpty(OffText) ? "OFF" : OffText); }

        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public Rectangle ButtonRectangle { get => _renderer.GetButtonRectangle(); }
        ...
        public bool ToggleOnButtonClick { get => _toggleOnButtonClick; set => _toggleOnButtonClick = value; }
        ...
        public bool ToggleOnSideClick { get => _toggleOnSideClick; set => _toggleOnSideClick = value; }
        ...
        public int ThresholdPercentage { get => _thresholdPercentage; set => _thresholdPercentage = value; }
        ...
        public bool UseAnimation { get => _useAnimation; set => _useAnimation = value; }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public new string Text { get => ""; set => base.Text = ""; }


        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public new Color ForeColor { get => Color.Black; set => base.ForeColor = Color.Black; }


        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public new Font Font { get => base.Font; set => base.Font = new Font(base.Font, FontStyle.Regular); }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool IsButtonHovered { get => _isButtonHovered && !_isButtonPressed; }


        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool IsButtonPressed { get => _isButtonPressed; }

        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool IsLeftSideHovered { get => _isLeftFieldHovered && !_isLeftFieldPressed; }


        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool IsLeftSidePressed { get => _isLeftFieldPressed; }


        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool IsRightSideHovered { get => _isRightFieldHovered && !_isRightFieldPressed; }

        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool IsRightSidePressed { get => _isRightFieldPressed; }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool IsButtonOnLeftSide { get => (ButtonValue <= 0); }

        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool IsButtonOnRightSide { get => (ButtonValue >= (Width - _renderer.GetButtonWidth())); }

        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool IsButtonMovingLeft { get => (_animating && !IsButtonOnLeftSide && _animationResult == false); }

        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool IsButtonMovingRight { get => (_animating && !IsButtonOnRightSide && _animationResult == true); }


        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal bool AnimationResult { get => _animationResult; }

        #endregion Private Properties

        #region Overridden Control Methods

        protected override Size DefaultSize {get=> new Size(50, 19); }
