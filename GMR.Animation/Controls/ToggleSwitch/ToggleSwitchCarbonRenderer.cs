...
namespace GMR.Animation.Controls.ToggleSwitch
{
    public class ToggleSwitchCarbonRenderer : ToggleSwitchRendererBase, IDisposable
    {
        ...
        public ToggleSwitchCarbonRenderer()
        {
            ...
            LeftSideBackColor1 = FlatColors.BlueDark;
            LeftSideBackColor2 = FlatColors.GrayLightBlue;
            RightSideBackColor1 = FlatColors.GrayDark;
            RightSideBackColor2 = FlatColors.Gray;
            ButtonNormalBorderColor1 = Color.FromArgb(255, 165, 167, 169);
            ButtonNormalBorderColor2 = Color.FromArgb(255, 130, 130, 130);
            ...
            if (ToggleSwitch.OnSideImage != null || !string.IsNullOrEmpty(ToggleSwitch.OnText))
            {
                ...
                if (ToggleSwitch.OnSideImage != null)
                {
                    ...
                    if (ToggleSwitch.OnSideScaleImageToFit)
                    {
                        ...
                        if (ToggleSwitch.OnSideAlignment == GMRToggleSwitch.ToggleSwitchAlignment.Center)
                            imageXPos = (int)((float)fullRectangle.X + (((float)fullRectangle.Width - (float)resizedImageSize.Width) / 2));
                        else if (ToggleSwitch.OnSideAlignment == GMRToggleSwitch.ToggleSwitchAlignment.Near)
            ...
            if (ToggleSwitch.OffSideImage != null || !string.IsNullOrEmpty(ToggleSwitch.OffText))
            {
                ...
                if (ToggleSwitch.OffSideImage != null)
                {
                    ...
                    if (ToggleSwitch.OffSideScaleImageToFit)
                    {
                        ...
                        if (ToggleSwitch.OffSideAlignment == GMRToggleSwitch.ToggleSwitchAlignment.Center)
                            imageXPos = (int)((float)fullRectangle.X + (((float)fullRectangle.Width - (float)resizedImageSize.Width) / 2));
                        else if (ToggleSwitch.OffSideAlignment == GMRToggleSwitch.ToggleSwitchAlignment.Far)
                            imageXPos = (int)((float)fullRectangle.X + (float)fullRectangle.Width - (float)resizedImageSize.Width);
        ...
        public override void RenderButton(Graphics g, Rectangle buttonRectangle)
        {
            ...
            using (GraphicsPath buttonPath = GetRoundedRectanglePath(buttonRectangle, CornerRadius))
            {
                ...
                if (buttonImage != null)
                {
                    ...
                    GMRToggleSwitch.ToggleSwitchButtonAlignment alignment = ToggleSwitch.ButtonImage != null ? ToggleSwitch.ButtonAlignment : (ToggleSwitch.Checked ? ToggleSwitch.OnButtonAlignment : ToggleSwitch.OffButtonAlignment);
                    ...
                    if (scaleImage)
                    {
                        ...
                        if (alignment == GMRToggleSwitch.ToggleSwitchButtonAlignment.Center)
                            imageXPos = (int)((float)buttonRectangle.X + (((float)buttonRectangle.Width - (float)resizedImageSize.Width) / 2));
                        else if (alignment == GMRToggleSwitch.ToggleSwitchButtonAlignment.Right)
        ...
        public override int GetButtonWidth() => (int)1.61f * (ToggleSwitch.Height - 2);
        ...
        public override Rectangle GetButtonRectangle(int buttonWidth) => new Rectangle(ToggleSwitch.ButtonValue, 0, buttonWidth, ToggleSwitch.Height);
