...
namespace GMR.Animation.Controls.ToggleSwitch
{
    public abstract class ToggleSwitchRendererBase
    {
        ...
        private GMRToggleSwitch _toggleSwitch;
        ...
        internal void SetToggleSwitch(GMRToggleSwitch toggleSwitch) => _toggleSwitch = toggleSwitch; 

        internal GMRToggleSwitch ToggleSwitch { get=> _toggleSwitch; }
